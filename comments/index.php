...
$commentsPerPage = 5;
$currentPage = 1;
$pagesCounter = ceil((count($comments) / $commentsPerPage));
...
$comments = array_slice($comments, ((--$currentPage) * $commentsPerPage), $commentsPerPage);
if (count($comments) == 0 && $pagesCounter > 0) {
